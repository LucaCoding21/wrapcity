...
export default function FacebookPosts() {
  ...
  // Get displayed posts based on viewport
  ...
  return (
    ...
    >
      <div className="container-wide">
        ...
        {/* Posts Grid - 3 columns on desktop, 2 on tablet, 1 on mobile */}
        <div
          ref={cardsRef}
              ...
              <div className="relative overflow-hidden rounded-2xl bg-neutral-100 shadow-md transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
                ...
                <div className="aspect-square overflow-hidden">
                  <iframe
                    ...
                    title={`Facebook ${post.type} ${i + 1}`}
                    loading="lazy"
                  />
                </div>

                {/* Clickable overlay to open Facebook post */}
                <a
                  href={decodeURIComponent(post.embedUrl.match(/href=([^&]+)/)?.[1] || "#")}
                  target="_blank"
